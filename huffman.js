...
class HuffmanCoder{
    ...
    encode(data){
        ...
        //mappings characters to binary string mappings
        let binary_string = "";
        for(let i=0;i<data.length;i++) {
            binary_string = binary_string + this.mappings[data[i]];
        }
        // padding binary ring to make length multiple of 8
        let rem = (8 - binary_string.length%8)%8;
        let padding = "";
        for(let i=0;i<rem;i++)
            padding = padding + "0";
        binary_string = binary_string + padding;
        // binary string to corrosponding character array 
        let result = "";
        for(let i=0;i<binary_string.length;i+=8){
          ...
          // concatinating required info to decode tree
    ...
    decode(data){
        ...
        //returing decoded text, tree structur, exta info 
